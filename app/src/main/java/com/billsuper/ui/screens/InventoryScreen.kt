...
import com.billsuper.ui.components.Chip
...
import com.billsuper.ui.components.PremiumSegmentedControl
...
import com.billsuper.ui.components.GlassButton
                    ...
                    Row(
                      ...
                      Row(horizontalArrangement = Arrangement.spacedBy(12.dp)) {
                        ...
                        IconButton(
                          ...
                          modifier = Modifier.size(40.dp).background(BillSuperColors.Red.copy(alpha = 0.1f), CircleShape)
                        ) {
                          Icon(Icons.Outlined.Delete, contentDescription = "Delete", tint = BillSuperColors.Red, modifier = Modifier.size(22.dp))
                        }
                      }
                    ...
                    Row(
                      ...
                      Row(horizontalArrangement = Arrangement.spacedBy(12.dp)) {
                        IconButton(
                          ...
                          modifier = Modifier.size(40.dp).background(BillSuperColors.PrimaryBlue.copy(alpha = 0.1f), CircleShape)
                        ) {
                          Icon(Icons.Outlined.Edit, contentDescription = "Edit", tint = BillSuperColors.PrimaryBlue, modifier = Modifier.size(22.dp))
                        }
                        IconButton(
                          onClick = {
                            vm.deleteProduct(
      ...
      ExposedDropdownMenuBox(
        ...
        OutlinedTextField(
          ...
          colors = OutlinedTextFieldDefaults.colors(
              ...
              focusedBorderColor = BillSuperColors.PrimaryBlue,
    ...
    if (initial == null) {
      Box(
        modifier = Modifier
          ...
          .dashedBorder(BillSuperColors.PrimaryBlue.copy(alpha = 0.3f), RoundedCornerShape(16.dp)),
        ...
        Row(verticalAlignment = Alignment.CenterVertically) {
          Icon(
            ...
            tint = BillSuperColors.PrimaryBlue,
            modifier = Modifier.size(20.dp)
          )
            ...
            if (resultMessage == null) {
                ...
                DarkCard {
                    Column(
                        ...
                        Row(verticalAlignment = Alignment.CenterVertically) {
                            Icon(Icons.Outlined.Info, contentDescription = null, tint = BillSuperColors.PrimaryBlue, modifier = Modifier.size(18.dp))
                            Spacer(Modifier.width(8.dp))
                ...
                Column(
                    ...
                    Icon(
                        ...
                        contentDescription = null,
                        tint = if (isError) BillSuperColors.Red else Color(0xFF4CAF50),
