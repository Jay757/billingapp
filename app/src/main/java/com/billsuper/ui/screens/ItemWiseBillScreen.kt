  ...
  ScreenSurface {
    Box(modifier = Modifier.fillMaxSize()) {
      ...
      if (!printMessage.isNullOrBlank()) {
          Text(printMessage!!, color = BillSuperColors.Primary, style = MaterialTheme.typography.labelMedium)
      }
...
private fun SaveBillDialog(
  ...
  com.billsuper.ui.components.BillSuperDialog(
    ...
    Column(verticalArrangement = Arrangement.spacedBy(16.dp)) {
      BillSuperTextField(value = "", onValueChange = {}, label = "Select Customer...", enabled = false)
      BillSuperTextField(
